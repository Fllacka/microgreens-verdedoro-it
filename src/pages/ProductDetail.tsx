              ...
              <CardContent className="p-6">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center justify-center gap-3 mb-3">
                    <Button variant="outline" size="icon" onClick={decrementQuantity} disabled={quantity <= 100} className="h-12 w-12 rounded-full border-2 disabled:opacity-30 hover:bg-verde-primary hover:text-white hover:border-verde-primary transition-all duration-200">
                    ...
                    <Button variant="outline" size="icon" onClick={incrementQuantity} className="h-12 w-12 rounded-full border-2 hover:bg-verde-primary hover:text-white hover:border-verde-primary transition-all duration-200">
                ...
                {/* Add to Cart Button */}
                <Button variant="oro" size="lg" className="w-full h-14 text-lg mb-4 shadow-oro hover:shadow-oro/50 transition-all duration-300" onClick={handleAddToCart}>
                ...
                <div className="flex items-center justify-center">
                  {product.inStock ? <Badge variant="secondary" className="bg-verde-primary/10 text-verde-primary">
                      ✓ Disponibile
