...
export const ContentBlockRenderer = ({ blocks }: ContentBlockRendererProps) => {
  ...
  const renderTextImageBlock = (block: ContentBlock) => {
    ...
    const textContent = (
      <div
        className="prose prose-lg max-w-none [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:list-decimal [&_ol]:pl-6 [&_li]:my-1 [&_a]:text-primary [&_a]:underline [&_p]:min-h-[1.5em] [&_p:empty]:min-h-[1.5em] [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:mt-6 [&_h2]:mb-3 [&_h3]:text-xl [&_h3]:font-bold [&_h3]:mt-5 [&_h3]:mb-2 [&_h4]:text-lg [&_h4]:font-semibold [&_h4]:mt-4 [&_h4]:mb-2"
